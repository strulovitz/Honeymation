...
## Overview
- **Target duration:** ~3-4 min (longer than Video 1 — four characters, chess explanation, growth path)
...
- **Image generation:** Pixar-style reference images via ChatGPT or Kling
...
**Visual:** Split screen. Left side: a company office building with a big "NEED AI" sign and money flying out. Right side: a neighborhood of houses, each with a small glowing computer. Money arrows flowing from the company to the houses. A big green LEGAL checkmark stamp.
...
## SCENE 13 — End Card + Cross-Link (5-8s) — APPROVED

**Visual:** Clean end card with logo, URL, tagline. Then a small preview thumbnail of Video 1 (the Lego style) appears in corner with text overlay for the cross-link.
...
**Estimated total: ~4 minutes** (can trim with tighter narration or stretch clips as needed)
