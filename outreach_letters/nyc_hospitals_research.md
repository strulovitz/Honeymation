# NYC Health + Hospitals (NYCHH) — Outreach Research

## WHY THIS IS A TOP PRIORITY TARGET

NYC Health + Hospitals (NYCHH) just DROPPED Palantir — one of the biggest AI/surveillance companies in the world. Their contract expires October 2026 and will NOT be renewed. CEO Mitchell Katz announced this at a March 16, 2026 city council meeting.

**Why they dropped Palantir:** Activists protested because Palantir is involved in:
- Lethal airstrike targeting
- Surveillance of American citizens  
- ICE deportation raids
- Palantir had access to patient health notes for insurance claim recovery (~$4M contract since Nov 2023)

**What they plan instead:** Bring data analysis IN-HOUSE. They have NO replacement yet.

**BONUS:** CEO Mitchell Katz also announced plans to use AI to replace radiologists for cancer screenings — they are ACTIVELY looking for AI solutions.

**Our pitch:** You just dropped Palantir because you don't trust them with patient data. We built a system where AI runs ENTIRELY on YOUR computers, inside YOUR hospitals, and NO patient data EVER leaves your building. This is exactly what you need.
...
- BMJ (British Medical Journal): https://www.bmj.com/content/392/bmj.s611
- Becker's Hospital Review: https://www.beckershospitalreview.com/radiology/nyc-health-hospitals-ceo-ai-could-replace-many-radiologists/

---

## THE SYSTEM — 11 Hospitals + 30 Clinics

NYC Health + Hospitals is the LARGEST public health care system in the United States. Over 1 million patients per year. 70+ facilities across all 5 boroughs.

### The 11 Acute Care Hospitals:

| # | Hospital | Borough | CEO |
|---|----------|---------|-----|
| 1 | **Bellevue** | Manhattan | Eric Wei, MD, MBA |
| 2 | **Metropolitan** | Manhattan | Julian John, MPA |
| 3 | **Harlem** | Manhattan | Georges H. Leconte |
| 4 | **Lincoln** | Bronx | Cristina Contreras, LMSW, MPA, FABC |
| 5 | **Jacobi / North Central Bronx** | Bronx | Christopher Mastromano, MBA |
| 6 | **Elmhurst** | Queens | Alina Moran, FACHE, FAB |
| 7 | **Queens** | Queens | Neil J. Moore, MBA, MPA, FACHE |
| 8 | **Kings County** | Brooklyn | Sheldon McLeod |
| 9 | **Woodhull** | Brooklyn | Sandra Sneed, MBA, FACHE |
| 10 | **South Brooklyn Health / Ruth Bader Ginsburg Hospital** | Brooklyn | Svetlana Lipyanskaya, MPA, FACHE |
| 11 | **Gouverneur** | Manhattan | Susan Sales, MPA, FACHE, LNHA |

Plus: **Gotham Health** (30 community clinics) — CEO: Michelle Lewis

### Long-term/Post-acute care:
- **Coler** (Roosevelt Island) — CEO: Nataliya Yakovleva
- **Carter** (Manhattan) — CEO: Floyd R. Long
- **McKinney** (Brooklyn) — CEO: Daveth Forbes-Thomas
- **Sea View** (Staten Island) — CEO: Matthew Levy
...
This is NOT a generic institutional email. This is a TARGETED pitch to people who:
1. Just DROPPED a Big Tech AI company (Palantir) over privacy/surveillance concerns
2. Need to bring AI capabilities IN-HOUSE
3. Have NO Chief AI Officer right now (position vacant)
4. Are actively exploring AI for radiology/cancer screening
5. Handle the most sensitive data imaginable (patient medical records)

**The letter must say:**
- "You just dropped Palantir because you couldn't trust them with patient data"
- "I built exactly what you need — AI that runs entirely inside your hospitals"
- "No patient data ever leaves your building — not to any cloud, not to any company"
- "Your Chief Data & AI Officer position is vacant — I can help fill that gap as a consultant"
- Mention the book, the videos, the open source code
- Offer a FREE pilot/demo at one hospital

**Who to write to:**
1. Mitchell Katz (CEO) — the decision maker
2. Kim Mendez (CIO) — the technology decision maker
3. PressOffice@nychhc.org — official channel
4. Eric Wei (Bellevue CEO) — the flagship hospital
5. Board Chair José A. Pagán — oversight

**Send to ALL of them. Different angle for each.**
