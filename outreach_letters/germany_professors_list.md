# German AI Professors — Personalized Letters (2026-04-08)

## Method: Same as France (deep research, connect to THEIR work, genuine question, in German)

| # | Name | Institution | Field | Email(s) |
|---|------|------------|-------|----------|
...
| 7 | Holger Fröning | Heidelberg University | Edge AI, hardware-aware inference, cloud-to-local | holger.froening@ziti.uni-heidelberg.de |
| 8 | Xiaoming Fu | University of Göttingen | Edge AI, decentralized privacy, 6G | fu@cs.uni-goettingen.de |
| 9 | Gerard de Melo | HPI Potsdam | LLMs, AI and Intelligent Systems | gerard.demelo@hpi.de |
| 10 | Laurent Bindschaedler | MPI-SWS | Distributed data systems + ML | bindsch@mpi-sws.org |

## Status: Emails collected. Letters NOT YET WRITTEN.
