...
Animated explainer videos for the [BeehiveOfAI](https://github.com/strulovitz/BeehiveOfAI) distributed AI platform.
...
- `characters/` — Character design prompts and reference images
- `scenes/` — Scene-by-scene prompts and generated clips
- `assets/` — Music, sound effects, and other media
- `planning/` — Production notes, concepts, and research
...
- [BeehiveOfAI](https://github.com/strulovitz/BeehiveOfAI) — The platform (Flask backend)
- [HoneycombOfAI](https://github.com/strulovitz/HoneycombOfAI) — The desktop client (PyQt6 GUI + CLI)
- [TheDistributedAIRevolution](https://github.com/strulovitz/TheDistributedAIRevolution) — The book
